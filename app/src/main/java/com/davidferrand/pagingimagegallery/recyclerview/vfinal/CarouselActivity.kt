...
import com.davidferrand.pagingimagegallery.databinding.ActivityCarouselRecyclerviewVfinalBinding
...
class CarouselActivity : AppCompatActivity() {
    private lateinit var binding: ActivityCarouselRecyclerviewVfinalBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCarouselRecyclerviewVfinalBinding.inflate(layoutInflater)
...
internal class CarouselAdapter(private val images: List<Image>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        return VH(AppCompatImageView(parent.context))
    }
